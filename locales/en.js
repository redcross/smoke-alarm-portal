{
	...
	"Out_of_region": "Sorry, the Red Cross Region serving %s County, %s does not utilize this website to accept smoke alarm installation requests.  Please call 800-REDCROSS (800-733-2767) to be connected to your servicing Region.  Thank you for contacting the Red Cross.",
        "Invalid_zip": "Sorry, we don't recognize any U.S. location for Zip Code \"%s\".  Are you sure you entered an accurate Zip Code?",
	"Text_address": "What is your address, including the unit number, city, state, and zipcode?",
	"Zip_text_error": "Sorry, we couldn't process your zipcode. Please text us your 5-digit zipcode.",
	"Text_phone_contact": "Is the number you're texting from the best way to get in touch with you?",
	"Text_alternate_phone": "If so, text YES. Otherwise, please text a phone number where we can reach you.",
	"Text_email_contact": "One last question: is there an email address we can use to contact you?  If not, text NONE. If yes, please text us the email address.",
	"Text_help_response": "This is the smoke alarm request system from the Red Cross.  For more information, call 1-800-RED-CROSS or visit getasmokealarm.org.",
        "Text_welcome": "Welcome to the smoke alarm request system (para continuar en espanol, mande el texto \"ES\"). We need to ask four questions to process your request. Please text back the answer to each and wait for the next question. First, what is your name?",
    "Contact_ARC": "To contact your local Red Cross about this request, call 1-800-RED-CROSS (1-800-733-2767). We will be in touch with you to schedule an installation."
}
