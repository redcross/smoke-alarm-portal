{
	...
	"Header_text": "COVID-19 UPDATE: You can request a smoke alarm installation, however, we are temporarily suspending the scheduling of appointments until public health conditions improve.",
	...
	"availability": "This form can accept requests from the following states and counties: AR (except Crittenden and Miller Counties), IA, ID, IL, KS, MN, MO, MT, ND, NE, SD, WA (except Clark, Cowlitz, Klickitat, Pacific, Skamania and Wahkiakum Counties), WI and Malheur County, OR.",
	...
	"Thank_request": "Thank you for your smoke alarm installation request.  If you need to contact the Red Cross about this request, use ID number %s.  Your information has been sent to the Red Cross representative for %s.  A representative will contact you with information on installation availability in your area.  Please allow two to four weeks for a response.",
        "Thank_request_text": "Thank you for your smoke alarm request! Your request number is %s. COVID-19 UPDATE: We are temporarily suspending the scheduling of appointments, however, you will be contacted once public health conditions improve.",
